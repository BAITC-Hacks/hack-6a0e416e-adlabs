...
def _instructions() -> str:
    return (
        ...
        "В summary дай прямой ответ именно на вопрос пользователя, а не общий рекламный текст о первой активности. "
        "В остальных полях кратко объясни вывод, ожидаемый эффект, ограничения и конкретный следующий шаг. "
        "Если вопрос вне данных Career Quest, честно скажи, что по этому вопросу данных нет, и предложи релевантный вопрос о карьере. "
